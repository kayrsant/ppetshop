                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-3">
                            <h2 class="fw-bold mb-2 text-uppercase">Cadastrar Pet</h2>
                            <p class="text-white-50 mb-5">Por favor, informe a raça, o animal, o nome e a idade.</p>
                            <form method="POST" action="pet">
                                ...
                                <div class="form-outline form-white mb-4">
                                    <input type="text" id="idade" name="idade" class="form-control form-control-lg" />
                                    <label class="form-label" for="idade">Idade do Pet</label>
                                </div>

                                <button class="btn btn-outline-light btn-lg px-5" type="submit" name="acao" value="criar">Cadastrar</button>
