                ...
                <div class="card bg-dark text-white" style="border-radius: 1rem;">
                    <div class="card-body p-5 text-center">
                        ...
                        <div class="mb-md-5 mt-md-4 pb-5">
                            ...
                            <p class="text-white-50 mb-5">Por favor, informe os dados solicitados.</p>
                            ...
                            <form method="POST" action="cadastrar">
                                ...
                                <div class="form-outline form-white mb-3">
                                    <input type="text" id="cpf" oninput="this.value = mascaraCPF(this.value)" name="cpf" class="form-control form-control-lg" />
                        ...
                        <div>
                            <p class="mb-0">Já tem uma conta? <a href="login.jsp" class="text-white-50 fw-bold">Logar-se</a>
                            </p>
                        </div>
